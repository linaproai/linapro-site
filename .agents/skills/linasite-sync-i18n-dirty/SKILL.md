...
description: >-
  ...
  删除要报告并在确认后删除对应英文 i18n 文件。英文标题和正文必须地道、专业、自然，绝不逐字翻译。
---
...
6. **地道英文优先** — frontmatter 标题、描述、关键词和正文标题都要符合英语技术文档习惯，不能机械直译
7. **保护无关改动** — 不修改不在当前 docs 变更清单里的文档，不回滚用户已有改动
...
2. 必要时读取同目录 1 到 3 篇已有英文文档，保持标题风格和术语一致。
3. 将整篇文档翻译或重新翻译到镜像路径；内容不同步时覆盖整文，不做零散局部 patch。
4. 保持 Markdown 结构、提示块、代码块、表格和 Mermaid 图表语法正确。
5. 确保父目录存在，再写入英文文件。
...
| 标题 | `title` 和正文 `##` / `###` 必须准确、自然、专业，符合英语技术文档命名习惯 |
