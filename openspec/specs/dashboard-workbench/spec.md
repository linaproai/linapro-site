...
### Requirement:工作台首页必须暴露真实的 LinaPro 管理入口
...
### Requirement:分析页面必须提供清晰的指标语义和时间范围切换
