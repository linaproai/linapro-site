...
var staticHostConfigDefaultSpecs = []hostConfigDefaultSpec{
	...
	{Key: "cluster.coordination.backend", Value: "redis"},
	{Key: "cluster.coordination.group", Value: "default"},
	{Key: "redis.default.connectTimeout", Value: "3s"},
	{Key: "redis.default.readTimeout", Value: "2s"},
	{Key: "redis.default.writeTimeout", Value: "2s"},
