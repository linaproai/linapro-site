...
func bindHostAPIRoutes(_ context.Context, server *ghttp.Server, runtime *httpRuntime) {
	var (
		...
		userCtrl       = user.NewV1(runtime.userSvc, runtime.roleSvc, runtime.menuSvc, runtime.orgSvc, runtime.tenantSvc, runtime.i18nSvc)
		userMsgCtrl    = usermsg.NewV1(runtime.bizCtxSvc, runtime.notifySvc, runtime.i18nSvc)
