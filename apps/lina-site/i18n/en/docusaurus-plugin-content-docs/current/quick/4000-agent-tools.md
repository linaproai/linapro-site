...
| OpenClaw | `skills/` | ⚠️ To be confirmed | Run `make skills.link AGENT=openclaw FORCE=1`; validate instruction file loading behavior |
| Cline | ✅ Supported | ✅ Supported | Put shared guidance in `AGENTS.md` and `Cline`-specific rules in `.clinerules/` |
...
| Qwen Code | `.qwen/skills/` | ⚠️ To be confirmed | `make skills.link AGENT=qwen-code; ln -s AGENTS.md QWEN.md` |
