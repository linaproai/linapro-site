...
- **[Dev Skills](/docs/agent-skills)**: The project's built-in AI skill library, spanning frontend design, code review, test coverage, performance auditing, and spec-driven workflows — giving AI tools the context they need to make framework-aware decisions in each specific scenario.
