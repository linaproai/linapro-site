...
hide_title: true
description: 'An introduction to the core design principles behind LinaPro — AI-native design, modular architecture, and AI spec-driven development — helping developers build the right mental model before going deeper into the framework.'
keywords:
  - design principles
  - AI-native
  - modular design
