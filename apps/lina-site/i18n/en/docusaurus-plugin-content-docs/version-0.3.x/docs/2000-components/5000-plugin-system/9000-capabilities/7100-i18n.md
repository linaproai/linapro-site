...
title: 'I18nService'
hide_title: true
description: 'the runtime translation service, translation key naming conventions, and the relationship between translation lookup and plugin language packs.'
keywords:
  - I18nService
...
- [APIDocService](./6600-apidoc.md) - Uses I18n to translate route labels and operation summaries
- [ConfigService](./7000-config.md) - Keys like `i18n.default` in configuration affect locale resolution
- [ManifestService](./7200-manifest.md) - Reads language pack resources under `manifest/i18n/`
