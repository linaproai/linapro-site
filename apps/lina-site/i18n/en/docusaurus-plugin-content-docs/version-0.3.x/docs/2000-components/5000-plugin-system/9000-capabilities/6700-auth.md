...
title: 'AuthService'
hide_title: true
description: "the two-phase authentication model, impersonation token governance boundaries, and the service's role in multi-tenant authentication flows for tenant token issuance, switching, and impersonation."
keywords:
  - AuthService
...
- [BizCtxService](./6800-bizctx.md) - Token information is projected into the business context
- [SessionService](./7800-session.md) - Token issuance and revocation synchronize session state
- [TenantService](./7900-tenant.md) - Visibility verification before tenant switching
