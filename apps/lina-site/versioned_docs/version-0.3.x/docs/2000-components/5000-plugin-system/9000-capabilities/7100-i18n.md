...
- [APIDocService](./6600-apidoc.md) - 使用`I18n`翻译路由标签和操作摘要
- [ConfigService](./7000-config.md) - 配置中的`i18n.default`等键影响`Locale`解析
- [ManifestService](./7200-manifest.md) - 读取`manifest/i18n/`下的语言包资源
