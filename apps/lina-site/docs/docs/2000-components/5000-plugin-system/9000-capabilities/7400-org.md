...
title: 'Org（组织能力）'
hide_title: true
description: '本文从架构设计角度介绍 LinaPro 的组织能力（orgcap.Service），说明组织能力的消费侧只读接口设计、Provider 扩展机制、能力降级策略和在组织数据权限中的位置，帮助插件开发者理解如何消费和扩展组织能力。'
keywords:
  - 组织能力
  - orgcap
  - 部门
...
- [TenantService](/docs/plugin-capability-tenant) - 租户能力与组织能力互补，共同构成多租户+组织的数据模型
- [PluginStateService](/docs/plugin-capability-plugin-state) - 使用IsProviderEnabled判断组织提供方是否可用
- [SessionService](/docs/plugin-capability-session) - 会话投影中的部门名称来自组织能力
